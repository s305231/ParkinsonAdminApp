...
import com.example.adminparkinson.adapter.WorkoutListAdapter
...
class WorkoutListActivity : AuxActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    fun printUserList(userList: ArrayList<User>) {

        println("Printed from method: " + userList)
            ...
            adapter.setOnClickListener(object : WorkoutListAdapter.OnClickListener {
                override fun onClick(position: Int, model: Workout) {
                    if (intent.hasExtra("EXERCISE")) {
                        ...
                        btn_assign_user.visibility = View.GONE
                        ...
                        intent.putExtra(Constants.DOCUMENT_ID, model.documentId)
                        startActivity(intent)*/
                        println("Workout clicked position is: " + position + " workout is: " + model.name + " workout doc id is: " + model.documentId)
                    }
                }
            })
    ...
    //Starts ViewAllUsers with extra
    fun assignUser(workout: Workout) {

        /*val intent = Intent(
                this@WorkoutListActivity,
                ViewAllUsers::class.java)
        intent.putExtra(Constants.DOCUMENT_ID, workout.documentId)
        startActivity(intent)*/

        val intent = Intent(this@WorkoutListActivity, ViewAllUsers::class.java)
